...
class CoordinationMetrics:
    ...
    last_coordination_check: Optional[datetime] = None
...
class ServerHealthMonitor:
    ...
    def get_server_status(self, server_name: str) -> Optional[ServerHealthMetrics]:
        """
...
_global_monitor: Optional[ServerHealthMonitor] = None
