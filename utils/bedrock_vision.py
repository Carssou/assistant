                ...
                "content": [
                    {
                        "image": {
                            "format": "jpeg",
                            "source": {
                                "bytes": base64_image  # Base64 string for Invoke API
                            }
                        }
                    },
                    {
...
async def analyze_full_screenshot_with_bedrock(
    ...
    """
    prompt = custom_prompt or "Please analyze this screenshot and describe what you see on the screen in detail."
...
async def analyze_region_screenshot_with_bedrock(
    ...
    """
    prompt = custom_prompt or f"Please analyze this screenshot of a specific screen region (coordinates: x={x}, y={y}, width={width}, height={height}) and describe what you see in detail."
    return await analyze_image_with_bedrock(image_bytes, prompt, config)
