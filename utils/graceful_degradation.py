...
from utils.server_monitor import ServerHealthMonitor, ServerStatus
...
class GracefulDegradationManager:
    ...
    def __init__(self, server_monitor: Optional[ServerHealthMonitor] = None):
        """
    ...
    def _find_alternative(self, unavailable_tool: str, available_tools: Set[str]) -> Tuple[Optional[str], str]:
        """
